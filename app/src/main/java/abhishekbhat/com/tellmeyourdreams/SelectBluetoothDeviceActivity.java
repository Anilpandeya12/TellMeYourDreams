    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
        {
            try {
                ...
                Intent i = new Intent(SelectBluetoothDeviceActivity.this, recordBrainWaveActivity.class);
                i.putExtra(EXTRA_DEVICE_ADDRESS, address);
                startActivity(i);
                Toast.makeText(SelectBluetoothDeviceActivity.this, "Starting activity.", Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                e.printStackTrace();
                Toast.makeText(SelectBluetoothDeviceActivity.this, "Couldn't Start activity.Click Again", Toast.LENGTH_SHORT).show();
            }
        }
    };
